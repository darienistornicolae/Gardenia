    ...
    var gardenList: some View {
        ...
        List(garden.plants.data, id: \.id) { plant in
            NavigationLink {
                ...
                PlantView(plant: PlantDetailsModel(id: plant.id, commonName: plant.commonName, scientificName: plant.scientificName, otherName: plant.otherName, dimension: "", dimensions: Dimensions(), cycle: plant.cycle.rawValue, watering: plant.watering.rawValue, description: "", otherImages: ""))
            } label: {
                HStack {
